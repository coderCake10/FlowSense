...
The API design assigns the Settings API to "common/settings" and the System
API to "common/system"; `common` holds shared code rather than models, so this
app owns the two tables and will host those APIs.
"""
