...
| `pnpm run lint` | 0 errors, 386 warnings | 0 errors, **372** warnings (the mobile page's unused imports are gone) |
| `pnpm test` | 27 | **46** |
| `pnpm run build` | Pass | Pass |
| `pnpm run qa:step1` | 36/36 | 36/36 (regression) |
| `pnpm run qa:step2` | n/a | 22/22, three runs in a row |
...
pnpm run qa:step2                            # screenshots in e2e/output/
```
