// Checks that every building model the kiosk needs is installed locally.
// Models are not in git; see docs/setup/building-models.md.
//
//   pnpm run models:check                       # checks client/public/models
//   FLOWSENSE_MODELS_DIR=/path pnpm run models:check
import {
  existsSync,
  openSync,
  readSync,
...
console.log(
  problems
    ? `\n${problems} of ${files.length} model(s) need attention. See docs/setup/building-models.md.`
    : `\nAll ${files.length} models are installed.`
);
